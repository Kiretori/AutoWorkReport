...
from email_service.email_generator import generate_report_html
from prefect import flow
from prefect.logging import get_run_logger
from tasks.queries import fetch_employees_per_date, fetch_absent_employees, fetch_employees_under_working, total_employee_count
...
def extract_data(target_date_id: int):
    ...
    if not employees_daily_data:
        logger.error("Couldn't get employee data")
        return
    ...
    html_report, csv_filepath = generate_report_html(daily_data)
