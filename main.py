...
from email_service.email_generator import generate_report_html, generate_csv_from_employees
...
def extract_data(target_date_id: int):
    ...
    csv_filepath = generate_csv_from_employees(employees_daily_data, f"daily_report{target_date_id}")
